...
const DICT = {
  ru: {
    ...
    ui: {
      ...
      'mains.chapters': 'Главы',
      'mains.fog.head': 'В ТУМАНЕ. ',
      'mains.fog.body': 'Нет ни одной главы, поэтому квест не даёт опыта. Назовите шаг, выполнимый за один заход.',
      'chapter.first': 'первый шаг на один заход',
      'chapter.next': 'следующий шаг',
      'chapter.label': 'Название главы',
    ...
    event: {
      ...
      chapter_added: { log: 'Глава · {title} · {name} · +{xp} XP' },
  ...
  en: {
    ...
    ui: {
      ...
      'mains.chapters': 'Chapters',
      'mains.fog.head': 'IN THE FOG. ',
      'mains.fog.body': 'No chapters, so this quest earns nothing. Name one step you can finish in a single sitting.',
    ...
    event: {
      ...
      chapter_added: { log: 'Chapter · {title} · {name} · +{xp} XP' },
